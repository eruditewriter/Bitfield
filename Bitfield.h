...
public:
    ...
    checked_bit_field(const std::nullptr_t)  noexcept : word(static_cast<word_t>(0)) {}

    //--Copy Assignments--
    //copy assignment operator
    checked_bit_field& operator=(const checked_bit_field& rhs) { if (this != &rhs) word = rhs.word; return *this; }
    volatile checked_bit_field& operator=(const checked_bit_field& rhs) volatile { if (this != &rhs) word = rhs.word; return *this; }
    volatile checked_bit_field& operator=(const volatile checked_bit_field& rhs) volatile { if (this != &rhs) word = rhs.word; return *this; }
    //copy assignment operator from bit mask
    checked_bit_field& operator=(const fieldbit_t& rhs) { word = rhs.word; return *this; }
    volatile checked_bit_field& operator=(const fieldbit_t& rhs) volatile { word = rhs.word; return *this; }
    //assignment operator to allow for assigning 0 (clearing bits)
    checked_bit_field& operator=(const std::nullptr_t&) { word = 0; return *this; }
    volatile checked_bit_field& operator=(const std::nullptr_t&) volatile { word = 0; return *this; }

    //--Operations--
    //0/NULL/nullptr to bitfield comparison operators
    friend bool operator==(const std::nullptr_t, const checked_bit_field& rhs) { return 0 == rhs.word; }
    friend bool operator!=(const std::nullptr_t, const checked_bit_field& rhs) { return 0 != rhs.word; }
    friend bool operator<=(const std::nullptr_t, const checked_bit_field& rhs) { return 0 <= rhs.word; }
    friend bool operator>=(const std::nullptr_t, const checked_bit_field& rhs) { return 0 >= rhs.word; }
    friend bool operator< (const std::nullptr_t, const checked_bit_field& rhs) { return 0 <  rhs.word; }
    friend bool operator> (const std::nullptr_t, const checked_bit_field& rhs) { return 0 >  rhs.word; }
    friend bool operator==(const std::nullptr_t, const volatile checked_bit_field& rhs) { return 0 == rhs.word; }
    friend bool operator!=(const std::nullptr_t, const volatile checked_bit_field& rhs) { return 0 != rhs.word; }
    friend bool operator<=(const std::nullptr_t, const volatile checked_bit_field& rhs) { return 0 <= rhs.word; }
    friend bool operator>=(const std::nullptr_t, const volatile checked_bit_field& rhs) { return 0 >= rhs.word; }
    friend bool operator< (const std::nullptr_t, const volatile checked_bit_field& rhs) { return 0 <  rhs.word; }
    ...
    friend checked_bit_field  operator& (const std::nullptr_t, const checked_bit_field&) { return checked_bit_field(static_cast<word_t>(0)); }
    friend checked_bit_field  operator| (const std::nullptr_t, const checked_bit_field& rhs) { return checked_bit_field(rhs.word); }
    friend checked_bit_field  operator^ (const std::nullptr_t, const checked_bit_field& rhs) { return checked_bit_field(rhs.word); }
    friend checked_bit_field  operator& (const std::nullptr_t, const volatile checked_bit_field&) { return checked_bit_field(static_cast<word_t>(0)); }
    friend checked_bit_field  operator| (const std::nullptr_t, const volatile checked_bit_field& rhs) { return checked_bit_field(rhs.word); }
    friend checked_bit_field  operator^ (const std::nullptr_t, const volatile checked_bit_field& rhs) { return checked_bit_field(rhs.word); }
    //bitfield to 0/NULL/nullptr comparison operators
    bool operator==(const std::nullptr_t) const { return word == 0; }
    bool operator!=(const std::nullptr_t) const { return word != 0; }
    bool operator<=(const std::nullptr_t) const { return word <= 0; }
    bool operator>=(const std::nullptr_t) const { return word >= 0; }
    bool operator< (const std::nullptr_t) const { return word < 0; }
    bool operator> (const std::nullptr_t) const { return word > 0; }
    bool operator==(const std::nullptr_t) const volatile { return word == 0; }
    bool operator!=(const std::nullptr_t) const volatile { return word != 0; }
    bool operator<=(const std::nullptr_t) const volatile { return word <= 0; }
    bool operator>=(const std::nullptr_t) const volatile { return word >= 0; }
    bool operator< (const std::nullptr_t) const volatile { return word < 0; }
    ...
    checked_bit_field  operator& (const std::nullptr_t) const { return checked_bit_field(static_cast<word_t>(0)); }
    checked_bit_field  operator| (const std::nullptr_t) const { return checked_bit_field(word); }
    checked_bit_field  operator^ (const std::nullptr_t) const { return checked_bit_field(word); }
    checked_bit_field  operator& (const std::nullptr_t) const volatile { return checked_bit_field(static_cast<word_t>(0)); }
    checked_bit_field  operator| (const std::nullptr_t) const volatile { return checked_bit_field(word); }
    checked_bit_field  operator^ (const std::nullptr_t) const volatile { return checked_bit_field(word); }
    checked_bit_field& operator&=(const std::nullptr_t) { word &= 0; return *this; }
    checked_bit_field& operator|=(const std::nullptr_t) { word |= 0; return *this; }
    checked_bit_field& operator^=(const std::nullptr_t) { word ^= 0; return *this; }
    ...
    bool operator< (const checked_bit_field& rhs) const { return word <  rhs.word; }
    bool operator> (const checked_bit_field& rhs) const { return word >  rhs.word; }
    bool operator==(const volatile checked_bit_field& rhs) const { return word == rhs.word; }
    bool operator==(const volatile checked_bit_field& rhs) const volatile { return word == rhs.word; }
    bool operator!=(const volatile checked_bit_field& rhs) const volatile { return word != rhs.word; }
    bool operator<=(const volatile checked_bit_field& rhs) const volatile { return word <= rhs.word; }
    bool operator>=(const volatile checked_bit_field& rhs) const volatile { return word >= rhs.word; }
    bool operator< (const volatile checked_bit_field& rhs) const volatile { return word <  rhs.word; }
    ...
    checked_bit_field  operator~ () const volatile { return checked_bit_field(~word); }
    checked_bit_field  operator& (const checked_bit_field& rhs) const { return checked_bit_field(word & rhs.word); }
    checked_bit_field  operator& (const checked_bit_field& rhs) const volatile { return checked_bit_field(word & rhs.word); }
    checked_bit_field  operator& (const volatile checked_bit_field& rhs) const { return checked_bit_field(word & rhs.word); }
    checked_bit_field  operator& (const volatile checked_bit_field& rhs) const volatile { return checked_bit_field(word & rhs.word); }
    ...
    checked_bit_field& operator|=(const checked_bit_field& rhs) { word |= rhs.word; return *this; }
    checked_bit_field& operator^=(const checked_bit_field& rhs) { word ^= rhs.word; return *this; }
    volatile checked_bit_field& operator&=(const checked_bit_field& rhs) volatile { word &= rhs.word; return *this; }
    volatile checked_bit_field& operator|=(const checked_bit_field& rhs) volatile { word |= rhs.word; return *this; }
    volatile checked_bit_field& operator^=(const checked_bit_field& rhs) volatile { word ^= rhs.word; return *this; }
    volatile checked_bit_field& operator&=(const volatile checked_bit_field& rhs) volatile { word &= rhs.word; return *this; }
    volatile checked_bit_field& operator|=(const volatile checked_bit_field& rhs) volatile { word |= rhs.word; return *this; }
    volatile checked_bit_field& operator^=(const volatile checked_bit_field& rhs) volatile { word ^= rhs.word; return *this; }
    //bitfield to bitmask comparison operators
    bool operator==(const fieldbit_t& rhs) const { return word == rhs.word; }
    bool operator==(const fieldbit_t& rhs) const volatile { return word == rhs.word; }
    bool operator!=(const fieldbit_t& rhs) const { return word != rhs.word; }
    bool operator!=(const fieldbit_t& rhs) const volatile { return word != rhs.word; }
    bool operator<=(const fieldbit_t& rhs) const { return word <= rhs.word; }
    bool operator<=(const fieldbit_t& rhs) const volatile { return word <= rhs.word; }
    ...
    checked_bit_field  operator& (const fieldbit_t& rhs) const volatile { return checked_bit_field(word & rhs.word); }
    checked_bit_field  operator| (const fieldbit_t& rhs) const { return checked_bit_field(word | rhs.word); }
    checked_bit_field  operator| (const fieldbit_t& rhs) const volatile { return checked_bit_field(word | rhs.word); }
    checked_bit_field  operator^ (const fieldbit_t& rhs) const { return checked_bit_field(word ^ rhs.word); }
    checked_bit_field  operator^ (const fieldbit_t& rhs) const volatile { return checked_bit_field(word ^ rhs.word); }
    ...
    checked_bit_field  operator<< (const unsigned int s) const { assert(s <= 8 * sizeof(word_t)); return checked_bit_field(word << s); }
    checked_bit_field  operator<< (const unsigned int s) const volatile { assert(s <= 8 * sizeof(word_t)); return checked_bit_field(word << s); }
    checked_bit_field  operator>> (const unsigned int s) const { assert(s <= 8 * sizeof(word_t)); return checked_bit_field(word >> s); }
    checked_bit_field  operator>> (const unsigned int s) const volatile { assert(s <= 8 * sizeof(word_t)); return checked_bit_field(word >> s); }
    checked_bit_field& operator<<=(const unsigned int s) { assert(s <= 8 * sizeof(word_t)); word <<= s; return *this; }
    checked_bit_field& operator>>=(const unsigned int s) { assert(s <= 8 * sizeof(word_t)); word >>= s; return *this; }
    volatile checked_bit_field& operator<<=(const unsigned int s) volatile { assert(s <= 8 * sizeof(word_t)); word <<= s; return *this; }
    volatile checked_bit_field& operator>>=(const unsigned int s) volatile { assert(s <= 8 * sizeof(word_t)); word >>= s; return *this; }

    //logical operators
    const bool operator!() const { return (word == 0 ? true : false); }
    const bool operator!() const volatile { return (word == 0 ? true : false); }
    ...
    explicit operator const bool() const { return (word != 0 ? true : false); }
    explicit operator const bool () const volatile { return (word != 0 ? true : false); }
...
public:
    ...
    bool operator==(const volatile field_t& rhs) const { return word == rhs.word; }
    bool operator!=(const field_t& rhs) const { return word != rhs.word; }
    bool operator!=(const volatile field_t& rhs) const { return word != rhs.word; }
    bool operator<=(const field_t& rhs) const { return word <= rhs.word; }
    bool operator<=(const volatile field_t& rhs) const { return word <= rhs.word; }
    ...
    field_t operator|(const volatile field_t& rhs) const { return field_t(word | rhs.word); }
    field_t operator&(const field_t& rhs) const { return field_t(word & rhs.word); }
    field_t operator&(const volatile field_t& rhs) const { return field_t(word & rhs.word); }
    field_t operator^(const field_t& rhs) const { return field_t(word ^ rhs.word); }
    field_t operator^(const volatile field_t& rhs) const { return field_t(word ^ rhs.word); }
...
#define BIT_FIELD( word_t,  bitfield_t )  namespace { bitfield_unique_id ui_##bitfield_t;} typedef checked_bit_field<&ui_##bitfield_t, word_t> bitfield_t
